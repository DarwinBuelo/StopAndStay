...
?>
 <!DOCTYPE html>
  ...
  <html lang="en-US">
     <head>
        <meta charset="UTF-8">
        <title>Billboard Nation | Classifieds</title>
           ...
           <div class="line">
              ...
              <div class="left">
                    <div style="width: 80%; margin-top: 5%;">
                        <form  class="customform" method="POST" action="includes/searchmain.php?page=classifieds">
        ...
        <div class="line">
           <div class="box margin-bottom">
              <div class="margin2x">
                 ...
                 <!-- CONTENT -->
                 <section class="s-12 m-12 l-9 xl-12"> 
              ...
              <!-- Pruducts -->
                <div class="margin">
                <div class="s-12 m-12 l-12 xl-12 xxl-8 center ">
                  ...
                  <!-- OUTPUT ALL AD POSTINGS -->
                    ...
                    {
                    $tag = $_GET['tagid'];
                    $sql=mysqli_query($conn,"SELECT * FROM tbl_classified where title Like '%$tag%' and stat = 1");
                    }
                    else{
                    $sql=mysqli_query($conn,"SELECT * from tbl_classified where stat = 1");   
                    }
                    ...
                    while($res=mysqli_fetch_array($sql))
                    {
                      ...
                      echo "<div class='s-12 m-6 l-12 xl-4 xxl4 item-container' style='padding-top:5px;'><div class='item-image'>";
                    // POSTING IMAGE
                    ...
                    echo "<p class='specs' style='padding-right:15px;white-space: nowrap;overflow: hidden; text-overflow: ellipsis;'>"
                    .$res['age']."<br>"
                    .$res['cond']."<br>"
                    .$res['location']."</p>";
                    echo '<p class="margin-bottom" style="padding-right:15px;white-space: nowrap;overflow: hidden; text-overflow: ellipsis;">'.$res['description'].'</p>';
                     echo "<a href='view_class.php?viewid=".$res['ID']."' class='button rounded-btn submit-btn s-12 l-10 m-10' type='submit'>View Ad</a>"; 
                    echo "</div></div></div>";
                    }
