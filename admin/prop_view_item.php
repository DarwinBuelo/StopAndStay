...
{
    $viewid=$_GET['item'];
    $sql="select * from tbl_property where ID = '".$_GET['item']."'";
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="prop_view.php" class="breadcrumb-link">View All Properties</a></li>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <!-- ========= CAROUSEL =========== -->
                                    <?php
                                    $sql1="select * from tbl_property where ID = '".$_GET['item']."'";
