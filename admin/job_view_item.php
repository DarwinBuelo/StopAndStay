                ...
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="job_view.php" class="breadcrumb-link">View All Jobs</a></li>
                  ...
                  <div class="margin2x">
                    ...
                    <div id="header-carousel" class="owl-carousel owl-theme">
                        ...
                        <p class="margin-bottom"><?php echo "Contact Number: ". $res['phone_number']; ?></p>
                        <p class="margin-bottom"><?php echo "Email: ". $res['email_address']; ?></p>
                        <p class="margin-bottom"><?php echo "Company Website: <a href='//".$res['company_website']."'>".$res['company_website']."</a>"?></p> 
