                        ...
                        <div class="page-header">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Job Opening</a></li>
                                    ...
                                    <table id="tspots_all" class="table table-striped table-bordered table-sm" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            while($row=mysqli_fetch_array($result))
                                            {
                                                ...
                                                echo "<td id='appadd'><a title='Approve' href='job_app.php?item=";
                                                echo $row['id']."'><i class='fas fa-check'>&nbsp;&nbsp;</i></a>";
                                                echo "<a href='job_view_item.php?item=";
