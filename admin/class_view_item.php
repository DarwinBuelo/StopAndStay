...
{
    $viewid=$_GET['item'];
    $sql="select * from tbl_classified where ID = '".$_GET['item']."'";
        ...
        <div class="dashboard-wrapper">
            <div class="influence-profile">
                <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Classifieds</a></li>
                                            <li class="breadcrumb-item"><a href="class_view.php" class="breadcrumb-link">View All Classifieds</a></li>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <!-- ========= CAROUSEL =========== -->
                                    <?php
                                    $sql1="select * from tbl_classified where ID = '".$_GET['item']."'";
                                    ...
                                    <div class="carousel-inner">
                                            ...
                                            
                                        {
                                           ...
                                           if($counter==0)
                                           {
                                            ...
                                            echo '<img class="d-block" style="width:1200px; height:375px; background-position: center center;
                  ...
                  $teabag=$_GET['item'];
                  $sql=mysqli_query($conn,"SELECT * FROM tbl_classified where id=$teabag");
                    ...
                    <div id="header-carousel" class="owl-carousel owl-theme">
                        ...
                        <tr>
                              <td style="text-align:left; padding:10px;">
                                 ...
                                 <strong>Age:</strong><?php echo $res['age']; ?>
                              </td>
                              <td style="text-align:left; padding:10px;">
                                 <!-- <img class="details_icons" src="../img/Calendar.png"> -->
                                 <strong>Condition:</strong><?php echo $res['cond']; ?>
                              </td>
                        </tr>
                        <tr>
                              <td style="text-align:left; padding:10px; ">
                                 <!-- <img class="details_icons" src="../img/Calendar.png"> -->
                                 <strong>Location:</strong><?php echo $res['location']; ?>
                              </td>

                              <td style="text-align:left; padding:10px; ">
                                 <!-- <img class="details_icons" src="../img/Calendar.png"> -->
                                 <strong>Contact:</strong><?php echo $res['contact']; ?>
                              </td>
                        </tr>
                         ...
                         <div class="card">
                            <div class="row">
                                <div class="col-md-2 col-lg-2 col-s-2 col-xl-2">
                                    ...
                                    if($res['stat']==0)
                                    {
                                        echo '<a href="class_app.php?id='.$res['ID'].'"><button class="btn btn-primary"><i class="fa fa-check"></i> Approve</button></a>';
                                    }
                                    else
                                    {
                                        echo '<a href="class_app.php?id='.$res['ID'].'"><button disabled class="btn btn-disabled"><i class="fa fa-check"></i> Approve</button></a>';
                                    }
                                    ?>
                                    </div>
                               <div class="col-md-2 col-lg-2 col-s-2 col-xl-2">
                                    <a href="class_dis.php?id=<?php echo $res['ID'];} ?>"><button class="btn btn-secondary"><i class="fa fa-check"></i> Decline</button></a>
                                </div>
                            </div>
                        </div>
