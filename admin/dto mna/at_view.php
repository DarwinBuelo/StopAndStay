                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tspots_all" class="table table-striped table-bordered table-sm" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php 
                                            include('at_pagination.php');
                                            while($row=mysqli_fetch_array($result))
                                            {
                                                echo "<tr><td>".$row['pend_title']."</td>";
                                                echo "<td id='appadd'>".$row['pend_model']."</td>";
                                                echo "<td id='appadd'>".$row['pend_price']."</td>";
                                                echo "<td id='appadd'>".$row['pend_year']."</td>";
                                                echo "<td id='appadd'>".$row['pend_loc']."</td>";
                                                ...
                                                echo "<td id='appadd'><a title='Approve' href='at_app.php?item=";
                                                echo $row['pend_id']."'><i class='fas fa-check'>&nbsp;&nbsp;</i></a>";
                                                echo "<a title='Decline' href='at_dis.php?item=";
                                                echo $row['pend_id']."'><i class='fas fa-exclamation-triangle'></i></a>";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                            ?>
                                     ...
                                     <?php
                                        ...
                                        for ($page=1;$page<=$number_of_pages;$page++) {
                                            echo '<a style="color:#007bff; font-size:15px;" href="at_view.php?page=' . $page . '">' . $page . '</a> ';
                                        }
                                        }
                                    ?>
                            </div>
