                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">View All Classifieds</h2>
                                        ...
                                        <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    <?php
                                                        if(isset($_GET['searchit']))
                                                        {
                                                            echo "<a href='tspot_view.php'><button type='submit' class='btn btn-secondary'>Clear</button></a>";
                                                        }
                                                    ?>
                                                </div>
                                            </div>
                                    ...
                                    <table id="tspots_all" class="table table-striped table-bordered table-sm" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            while($row=mysqli_fetch_array($result))
                                            {
                                                ...
                                                echo "<td id='appadd'>".$row['contact']."</td>";
                                                echo "<td id='appadd'>".$row['price']."</td>";
                                                ...
                                                echo "<td id='appadd'><a title='Approve' href='class_app.php?item=";
                                                echo $row['ID']."'><i class='fas fa-check'>&nbsp;&nbsp;</i></a>";
                                                echo "<a href='class_view_item.php?item=";
                                     ...
                                     <?php
                                        ...
                                        for ($page=1;$page<=$number_of_pages;$page++) {
                                            echo '<a style="color:#007bff; font-size:15px;" href="class_view.php?page=' . $page . '">' . $page . '</a> ';
                                        }
                                        }
                                    ?>
                            </div>
