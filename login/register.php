...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form p-l-35 p-r-55 p-t-120" method="POST"
                  action="../includes/register_user.php">
                        <span class="login100-form-title" style="
                              padding-top: 20px; padding-bottom:20px;  background-color: #4FBFA8;;
                              ">
                            Register
                        </span>
                <!--	<input type="hidden" name="hid_val" id="hid_val" value="12"> -->
                ...
                <br>
                <div class="col-md-6">
                    <input type="radio" name="role" value="1" checked>Landlord
                    <input type="radio" name="role" value="0">Tenant
                </div>
